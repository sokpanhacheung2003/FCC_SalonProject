...
INSERT INTO public.appointments VALUES (8, '10:30', 1, 8);
...
INSERT INTO public.customers VALUES (2, '1', 'sop');
INSERT INTO public.customers VALUES (8, '555-555-55555', 'Fabio');
...
--
-- Name: appointments appointment_customers; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT appointment_customers FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id);
